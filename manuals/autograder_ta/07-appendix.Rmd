...
**Description**: Runs all the setup to send individualized datasets. The majority of the script is the setup for `gmailR` as well as statements to catch input errors. This is never called directly by a TA. Rather, it is implicitely used when running `inputs_email.R`

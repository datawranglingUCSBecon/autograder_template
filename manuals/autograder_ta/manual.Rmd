...
This is a working draft of the manual. Please do not distribute. Please do not share this manual with current or potential students of **Data Wrangling in R**.
>>>>>>> 94fe50659473f1d8b99903bfc1478f4eeff374c9
...
I will go through each of the 4 folders listed above and subsequent files:
...
```{r, echo=FALSE}
test.results <- data.frame("name"= rep(NA,2),
                               "score" = rep(NA,2),
                               "maxscore" = rep(NA,2),
                               "output" = rep(NA,2))
test.results
